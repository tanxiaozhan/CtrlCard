...
t <td>
t <input name=pw0 type=password id=pw0 class=tbs size=10 maxlength=10></td></tr>
t <tr><td align="right"><img src=pabb.gif height="40px">确认密码：</td>
t <td>
t <input type=password name=pw2 id=pw2 size=10 maxlength=10 class=tbs></td></tr>
t </table><p align=center>
t <input type=button name=set value="提 交" onClick="changeConfirm(this.form)" class="tbs">
t &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=reset value="清 除" class="tbs"></p>
t </form>
