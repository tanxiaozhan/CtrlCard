...
t <tr><td width="269" height="85" align="right" valign="middle"><img src=pabb.gif>分区号：</td>
t <td width="270" valign="middle">
c a n <input class=tbs name=areaNo type=text readonly=readonly size=15 value=%d />
t </td><td width="261">1-3</td></tr>
t <tr><td height="85" align="right" valign="middle"><img src=pabb.gif>X 坐标：</td><td>
c a x <input class=tbs name=X type=text id=X size=15 value=%d />
t </td><td>&nbsp;</td></tr>
t <tr><td height="85" align="right" valign="middle"><img src=pabb.gif>Y 坐标：</td><td>
c a y <input class=tbs name=Y type=text id=Y size=15  value=%d />
t </td><td align="left" valign="middle">&nbsp;</td></tr>
t <tr><td height="85" align="right" valign="middle"><img src=pabb.gif>宽　度：</td><td>
c a w <input class=tbs name=Width type=text id=Width size=15 value=%d />
t </td><td align="left" valign="middle">&nbsp;</td></tr>
t <tr><td height="85" align="right" valign="middle"><img src=pabb.gif>高　度：</td><td>
c a h <input class=tbs name=Height type=text id=Height size=15 value=%d />
t </td><td align="left" valign="middle">&nbsp;</td></tr>
...
t <td width="13%" height="30" align="center">&nbsp;</td></tr></table></td><td>&nbsp;</td></tr>
