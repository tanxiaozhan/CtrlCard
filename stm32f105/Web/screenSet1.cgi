...
t <tr><td width="204" height="85" align="right" valign="middle"><img src=pabb.gif height="40px">屏宽：</td>
t <td width="270" valign="middle">
c s w <input class=tbs name=ScreenWidth type=text id=Width size=15 value=%d />
t </td><td width="326">&nbsp;</td></tr>
t <tr><td height="85" align="right" valign="middle"><img src=pabb.gif height="40px">屏高：</td><td>
c s h <input class=tbs name=ScreenHeight type=text id=Height size=15 value=%d />
t </td><td>&nbsp;</td></tr>
t <tr><td height="85" align="right" valign="middle"><img src=pabb.gif height="40px">亮度：</td><td>
c s l <input class=tbs name=ScreenLight type=text id=Light size=15 value=%d />
